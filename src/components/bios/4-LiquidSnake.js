...
import LiquidSnakeBox from '../4-LiquidSnake-Comments/LiquidSnakeBox'
import { Button } from 'reactstrap';
import LiquidSnakeStats from '../characters/LiquidSnakeStats'
import { ModalHeader } from 'reactstrap';
 
export default class LiquidSnake extends React.Component {
  state = {
    open: false,
  };
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div>
        <img className="boxmodal" width="100%" src="https://cdnb.artstation.com/p/assets/images/images/006/924/155/large/ariel-li-newly-commander.jpg?1502292572" alt="LiquidSnakeHero" />
        </div>
        <div className="main">
          <center>
          <p>
          <br/>
          "There's a killer inside you..."<br /> <br />
          </p>
          <h2>-Liquid Snake</h2>
          </center>
          <LiquidSnakeStats />
          ...
          <center> 
          <img height="100%" width="70%" src="https://i.pinimg.com/474x/88/e6/ec/88e6ecbb1c85d2bd34f5c5d5af2a5c47--liquid-snake-metal-gear-solid.jpg" alt="LiquidWantsYou" />
          <br /><br />
          <h4>Biography</h4>
          </center>
          <hr />
          ...
          <center>
          <img height="100%" width="90%"src="https://i.pinimg.com/474x/7f/0a/18/7f0a188effe550422fc303a1186d13e1--wii-games-metal-gear-solid.jpg" alt="mgs3Bridge" />
          </center>
          <br /> <br />
          <p>
          ...
          <center>
          <img height="100%" width="70%" src="https://i.pinimg.com/474x/e3/20/db/e320dbcbd92fe3a9922051f086828902--snakes-fanart.jpg" alt="mgs3Bridge" />
          </center>
          </div>
        <LiquidSnakeBox />
        </Modal>
